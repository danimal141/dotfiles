...
設計思想は [docs/design-philosophy-ja.md](docs/design-philosophy-ja.md) を参照。
...
* Node / Python ランタイム前提の CLI (markdownlint-cli, marp-cli)
...
ghostty / ctags / google-ime / mise の config.toml / markdownlint) は
**`nvim ~/.zshrc` で repo 内ファイルを直接編集** することになる:
