...
[English](vscode-neovim-use.md) | 日本語
...
* [`docs/vscode-use-ja.md`](./vscode-use-ja.md) — VSCode 全般の運用
* [`docs/design-philosophy-ja.md`](./design-philosophy-ja.md) — dotfiles の設計思想
