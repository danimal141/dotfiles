...
chezmoi は v1 構成で使っていたが Phase 4 で完全撤去済み (履歴は
`docs/design-philosophy-v1.md`)。
...
* `docs/design-philosophy.md` — 設計思想 (新版、nix-only)
* `docs/design-philosophy-v1.md` — chezmoi + nix 二層構成の旧版設計 (履歴用)
